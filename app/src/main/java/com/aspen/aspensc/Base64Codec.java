...
/**
 * Created by French on 1/15/2015.
 */
...
//This class converts bitmap image to text, and has the ability to convert the text back to bitmap
//To store any image in sqlite database you need to store that image in byte array instead of string.
// Convert that image to byte array & store that byte [] to DB. While retrieving that image you will
